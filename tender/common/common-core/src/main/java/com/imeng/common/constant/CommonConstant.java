package com.imeng.common.constant;
...
public interface CommonConstant {
     ...
     * 服务实例环境
     */
    String SERVICE_INSTANCE_ENV = "service.instance.env";

    /**
     * 请求上下文服务实例环境
     */
    String REQUEST_INSTANCE_ENV_HEADER = "service-instance-env";

    /**
     * 请求源主机
     */
    String REQUEST_SOURCE_HOST = "request-source-host";
}
