...
public class AuthUtils {
    ...
    public static void main(String[] args) {
        System.out.println(extractHeaderClient("Basic ZGV2V2ViOmRldldlYg=="));
        byte[] s = Base64.getEncoder().encode(new String("devWeb:devWeb:scope").getBytes());
