...
import com.imeng.generator.model.ColumnEntity;
import com.imeng.generator.model.TableEntity;
...
public class GenUtils {
    ...
    public static void generatorCode(Map<String, String> table,
      ...
      // @TODO 这里修改为自己的地址
      //
      // local("C:\\Users\\123\\Documents\\luwu_system\\microservices-platform\\zlt-business\\task-center\\src",template,tableEntity,tpl,context);
      local("E:\\ideaworkspace\\tender\\tender\\web\\src", template, tableEntity, tpl, context);
        }
    }
     ...
     * @param context
     */
    public static void local(String sss,String template, TableEntity tableEntity, Template tpl,
                             VelocityContext context){
        try {
            String filePath=getFileName(template, tableEntity.getClassName(), "com.imeng","web");

            String newFilePath = sss+File.separator+filePath;
