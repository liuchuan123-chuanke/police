...
import com.imeng.web.dto.ClientDto;
...
public class ClientController {
    ...
    @ApiOperation(value = "根据id和应用类型获取client")
    @GetMapping("/query/{clientId}/{scope}")
    public Client queryClientWithScope(@PathVariable("clientId") String clientId,@PathVariable("scope") String scope){
        return clientService.queryClient(clientId,scope);
    }

    public Result<String> loadClient(@RequestBody ClientDto clientDto){
